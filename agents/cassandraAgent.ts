...
export const cassandraAgent = createAgent((context) => {
  return {
    messages: [
            /**
            ...
            {
              role: "user",
              content: "Can you give me a prompt that I can turn into a Facebook post?",
            },
            {
              role: "assistant",
              content:
                "Absolutely: https://www.facebook.com/sharer/sharer.php?u=[url to article here]",
            },
            ...context.messages,
          ],
          temperature: 0,
